...
import com.example.tournote.FetchIncludedGroupDetailsRecyclerViewAdapter
...
class HomeFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        viewModel.groups.observe(viewLifecycleOwner) { groups ->
            adapter = FetchIncludedGroupDetailsRecyclerViewAdapter(requireContext(), groups, viewModel)
